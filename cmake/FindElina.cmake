...
if (NOT ELINA_FOUND)
  ...
  find_library(Elina_TOP_Lib NAMES top PATHS ${ELINA_ROOT}/lib NO_DEFAULT_PATH)
  ...
  set(ELINA_LIBRARY ${Elina_Poly_Lib}
    ${Elina_Opt_Oct_Lib} ${Elina_TVPI_Lib} ${Elina_TOP_Lib} ${Elina_Linearize_Lib} ${Elina_Aux_Lib}
